...
if __name__ == '__main__':
    row_lists = [['Arab World', 'ARB', 'Adolescent fertility rate (births per 1,000 women ages 15-19)', 'SP.ADO.TFRT', '1960', '133.56090740552298'], ['Arab World', 'ARB', 'Age dependency ratio (% of working-age population)', 'SP.POP.DPND', '1960', '87.7976011532547'],
    ...
    feature_names = ['CountryName',
                     ...
                     'Year',
                     'Value']
    list_of_dicts = [dict(lists2dict(feature_names, row)) for row in row_lists]
    print(list_of_dicts)
