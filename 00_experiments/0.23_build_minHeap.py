...
# Good job! (Max time used: 0.27/3.00, max memory used: 26042368/536870912.)
def build_min_heap_rec(nums):
    solution = []
    n = len(nums)
    ...
    def heapify_min(i):
        ...
        # check if the heap property satisfied, if NO: append corresponding indices to solution, swap numbers
...
if __name__ == '__main__':
    ...
    pairs_of_swap_indices = build_min_heap_rec(nums)
